...
# cobadapatkan jumlah huruf dari kata diatas
print("panjang array atau jumlah hruf falam kaimat diatas adalah = "+str(len(astring)))

# coba sekarang cari di indeks berapa sebuah huruf l berada dalam kalimat
print("huruf l pertama kali ditemukan pada indeks ke ("+str(astring.index("l"))+") dalam kalimat ("+astring+")")
